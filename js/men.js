export function renderMen(){
    ...
    main.innerHTML=''
    const items =  fetch('js/item.json').then(res=>res.json()).then((data)=>{return data.men.arr })
 items.then(arr=>{
    let itemsHtml = ''
       arr.forEach(el => {
            itemsHtml+=`
        ...
        <div class="container">
            <div class="categori">
                <a href="#" class="category_card">
                    <img src="img/catalog/shirt.png" alt="" class="category_img">
                    <p class="category_name">Футболка</p>
                </a>
                <a href="#" class="category_card">
                    <img src="img/catalog/addidas.jpg" alt="" class="category_img">
                    <p class="category_name">Кроссовки</p>
                </a>
                <a href="#" class="category_card">
                    <img src="img/catalog/trousers.jpg" alt="" class="category_img">
                    <p class="category_name">Брюки</p>
                </a>
                <a href="#" class="category_card">
                    <img src="img/catalog/jaket.jpg" alt="" class="category_img">
                    <p class="category_name">Верхняя одежда</p>
                </a>
                <a href="#" class="category_card">
                    <img src="img/catalog/bag.jpg" alt="" class="category_img">
                    <p class="category_name">Аксессуары</p>
                </a>
                <a href="#" class="category_card">
                    <img src="img/catalog/sport.jpg" alt="" class="category_img">
                    <p class="category_name">Спорт</p>
                </a>
                <a href="#" class="category_card">
                    <img src="img/catalog/suit.webp" alt="" class="category_img">
                    <p class="category_name">Костюмы</p>
                </a>
                <a href="#" class="category_card">
                    <img src="img/catalog/blose.webp" alt="" class="category_img">
                    <p class="category_name">Кофты</p>
                </a>
  
            </div>
        </div>
        <div class="catalog">
        <h2 class="catalog__title">Мужская одежда</h2>
